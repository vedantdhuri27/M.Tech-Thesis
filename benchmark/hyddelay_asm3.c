...
#define S_FUNCTION_NAME hyddelay_asm3
...
if (timeconst > 0.000001) {
  dx[0] = (u[0]*u[13]-x[0])/timeconst;
  dx[1] = (u[1]*u[13]-x[1])/timeconst;
  dx[2] = (u[2]*u[13]-x[2])/timeconst;
  dx[3] = (u[3]*u[13]-x[3])/timeconst;
  dx[4] = (u[4]*u[13]-x[4])/timeconst;
  dx[5] = (u[5]*u[13]-x[5])/timeconst;
  dx[6] = (u[6]*u[13]-x[6])/timeconst;
  dx[7] = (u[7]*u[13]-x[7])/timeconst;
  dx[8] = (u[8]*u[13]-x[8])/timeconst;
  dx[9] = (u[9]*u[13]-x[9])/timeconst;
  dx[10] = (u[10]*u[13]-x[10])/timeconst;
  dx[11] = (u[11]*u[13]-x[11])/timeconst;
  
  dx[12] = (u[12]*u[13]-x[12])/timeconst;       /* TSS */
  dx[13] = (u[13]-x[13])/timeconst;             /* Flow rate */
  dx[14] = (u[14]-x[14])/timeconst;             /* Temp */
  
  /* dummy states */
  dx[15] = (u[15]*u[13]-x[15])/timeconst;
  dx[16] = (u[16]*u[13]-x[16])/timeconst;
  dx[17] = (u[17]*u[13]-x[17])/timeconst;
  dx[18] = (u[18]*u[13]-x[18])/timeconst;
  dx[19] = (u[19]*u[13]-x[19])/timeconst;
 }
