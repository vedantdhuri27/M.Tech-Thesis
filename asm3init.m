...
S_I_ASin = 49.06*(Qin+Qin0+Qintr);
S_S_ASin = 107.36*(Qin+Qin0+Qintr);
S_NH4_ASin = 31.17*(Qin+Qin0+Qintr);
S_N2_ASin =0.0001* (Qin+Qin0+Qintr);
S_NOX_ASin = 0.0001*(Qin+Qin0+Qintr);
S_ALK_ASin = 6.44*(Qin+Qin0+Qintr);
X_I_ASin = 37.56*(Qin+Qin0+Qintr);
X_S_ASin = 162.74*(Qin+Qin0+Qintr);
%X_H_ASin = 28.17*(Qin+Qin0+Qintr);
X_H_ASin = 0*(Qin+Qin0+Qintr);
